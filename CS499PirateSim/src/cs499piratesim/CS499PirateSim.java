...
//C:\Users\philip>"C:\Program Files\Java\jdk1.8.0_45\bin\java" -jar "C:\Users\philip\Documents\NetBeansProjects\CS499PirateSim\dist\CS499PirateSim.jar"
/**
 *
 * @author Owen
 */
public class CS499PirateSim {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        Simulation sim = new Simulation(80, 40, 0.3, 0.25, 0.2, 653745); //(401, 101, 0.5, 0.4, 0.25, 0);
        for (int i = 0; i < 400; i++) {
            sim.tick();
            sim.textDisplay();
...
class Simulation {
    ...
    final int CARGO = 0, PIRATE = 1, PATROL = 2, CAPTURED = 3, WRECK = 4;
    double probNewShip [];
    int timestep;
    Random rand;
    ...
    Duration getElapsedTime() {return Duration.ofMinutes(timestep*5);}
